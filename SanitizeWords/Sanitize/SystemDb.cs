...
namespace Sanitize
{
    ...
    public sealed class SystemDB
    {
        ...
        public List<WordModel> Data = new List<WordModel>();
        public SystemDB()
        {

            var stringlist = new List<string>{"ACTION"
                                        , "ADD"
                                        , "ALL"
                                        , "ALLOCATE"
                                        , "ALTER"
            ...
            {
                wordModels.Add(new WordModel { Id = countID++, Word = i });
            }

            Data.AddRange(wordModels);
